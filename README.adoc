...
The project you create needs to include `spring-ws-core` as a dependency in your build file.
...
You can now test this use by performing a `GET`. For example, using the *nix curl tool:

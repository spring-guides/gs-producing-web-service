...
You can use this https://start.spring.io/#!type=gradle-project&groupId=com.example&artifactId=producing-web-service&name=producing-web-service&description=Demo%20project%20for%20Spring%20Boot&packageName=com.example.producing-web-service&dependencies=web-services[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
[source,xml,indent=0]
----
include::complete/pom.xml[tags=dependencies]
----
...
[source,xml,indent=0]
----
include::complete/src/main/resources/META-INF/schemas/countriesWs.xsd[]
----
